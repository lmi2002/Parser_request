...
if __name__ == '__main__':
    up = Ukrparts(num='1-23-4-5fafaf', brand='febi')
    print(up.get_item())
...
# result_page = bs(requests.get('https://ukrparts.com.ua/search/' + num_ex + '/' ).content, 'html.parser')
#
# card = result_page.find('div', class_='part_brand', string=re.compile(brand_ex, re.I)).parent
#
# price = card.find('div', class_='price_min').get_text()
# term = card.find('div', class_='limitation').get_text()
#
# print(price, term)